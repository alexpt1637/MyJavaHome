package ru.dvfu.mrcpk.java.proj01.Practice_01;
...
public class Practice_01 {
    public static void main(String[] args) {
        ...
        */
        ...
        // Цикл while
        /* int v = 0;                          // Объявляем начальное значение переменной
        while (v < 5) {                     // Цикл будет повторяться пока верно данное условие
            System.out.println("Hello " + v);
            v++;                            // v = v + 1 т.е. с каждым циклом увеличиваем на единицу
        }
        */

        // Цикл for
        /* for (int i = 0; i <= 10; i = i + 2) {   // Цикл будет повторяться пока верно данное условие
            System.out.println("Hello " + i);   // i = i + 2 с каждым циклом увеличиваем на 2 единицы, можно на одну: i++
        }
        */
        for (int i = 10; i > 0; i--) {   // Цикл будет повторяться пока верно данное условие
            System.out.println("Hello " + i);   // i с каждым циклом i--
        }
